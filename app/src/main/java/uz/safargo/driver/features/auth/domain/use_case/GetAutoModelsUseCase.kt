...
class GetAutoModelsUseCase @Inject constructor(
    private val repository: AuthRepository
) : UseCase<List<AutoModelEntity>, MainParams>() {

    override fun call(params: MainParams): Flow<Either<List<AutoModelEntity>>> {
        return repository.getAutoModels(params.request)
    }
}
